...
class Merge():
    ...
    def read_json_file(file_path):
        ...
        return json.loads(raw_data.decode(encoding, errors='ignore'))

    def read_list(self):
        # 使用 self.list_file 调用静态方法 read_json_file
        raw_list = Merge.read_json_file(self.list_file)
        input_list = []
    ...
    def readme_update(self): # 更新 README 节点信息
        ...
        with open(f'{self.merge_dir}sub_merge.txt', 'r', encoding='utf-8') as f:
            ...
            for repo in self.url_list:
                ...
                if remarks != "469138946ba5fa/docker-arch-subs-topfreeproxies":
                    thanks.append(line)
            f.close()
